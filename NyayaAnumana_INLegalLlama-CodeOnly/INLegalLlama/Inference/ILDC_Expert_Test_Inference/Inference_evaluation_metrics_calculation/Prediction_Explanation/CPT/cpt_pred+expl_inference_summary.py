...
actual = [int(i) for i in df['Official Decision'].tolist()[1:]]
...
import json
with open("/content/drive/MyDrive/MTECH_THESIS/LegalLLM/Inference_final_csvs_CPT_SFT/ILDC_54/Summary_infer_results_cpt_ILDC.json", "w") as outfile:
