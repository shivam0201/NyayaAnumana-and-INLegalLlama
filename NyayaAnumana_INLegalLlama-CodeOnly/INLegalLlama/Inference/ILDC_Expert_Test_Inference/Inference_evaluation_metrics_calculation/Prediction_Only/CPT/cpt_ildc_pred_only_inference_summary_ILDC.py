...
def clean(text):
  ...
  positive_terms = ["succeeded", "succeeds", "succeed", "approved", "approve", "affirmed", "accept", "allow", "allowed", "granted", "accepted","agreed"]
  negative_terms = ["dismiss", "reject","disposed of", "remand", "denied", "rejected", "disapproved", "dismissed", "revoked", "annulled", "invalidated", "disallowed", "dismissed", "revoke"]
