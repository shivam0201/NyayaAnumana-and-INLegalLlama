...
#Step-3: Train and Evaluation Dataset Initialization
df_train = pd.read_csv("train.csv") ###GIVE THE PATH TO TRAIN.CSV DOWNLOADED FROM README OF CURRENT DIRECTORY###
df_val = pd.read_csv("val.csv") ###GIVE THE PATH TO val.CSV DOWNLOADED FROM README OF CURRENT DIRECTORY###
...
OUTPUT_DIR = "output" ###OUTPUT FOLDER WHERE THE FINE-TUNED MODEL NEEDS TO BE SAVED###
...
trainer = SFTTrainer(
    ...
    max_seq_length=2500, # adjust Sequence Length according to your resource availability
    tokenizer=tokenizer,
